...
class Encoder_att(nn.Module):
    def __init__(self, in_channels):
        ...
        self.sk_conv1 = nn.Conv2d(1, in_channels*4,3, 1, 1, bias=False)
        self.sk_conv2 = nn.Conv2d(1, in_channels*8, 3, 1, 1, bias=False)
        self.sk_conv3 = nn.Conv2d(1, in_channels*16, 3, 1, 1, bias=False)
#         self.sk_conv4 = nn.Conv2d(3, in_channels*8, 3, 1, 1, bias=False)

        self.sk_conv5 = nn.Conv2d(1, in_channels*4,3, 1, 1, bias=False)
        self.sk_conv6 = nn.Conv2d(1, in_channels*8, 3, 1, 1, bias=False)
        self.sk_conv7 = nn.Conv2d(1, in_channels*16, 3, 1, 1, bias=False)
#         self.sk_conv8 = nn.Conv2d(3, in_channels*8, 3, 1, 1, bias=False)
...
# skips[fir_pool3] 4
    ...
    #         print('skips[fir_pool3]',len(skips['fir_pool3']))
        ...
        adaptive_feature = self.cf1(high+low)
        # print(high.shape)
        # print(low.shape)
